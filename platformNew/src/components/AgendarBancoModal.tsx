...
import { agendarBancoAula } from '@/services/banco'
...
export function AgendarBancoModal({
  ...
  async function handleAgendar() {
    ...
    try {
      await agendarBancoAula(turmaId, banco.id, { date, startTime, endTime }, user!.role)
    } catch (e) {
      setSaving(false)
      return setError(e instanceof Error ? e.message : 'Erro ao agendar.')
    }
    setSaving(false)
    onAgendado()
  }

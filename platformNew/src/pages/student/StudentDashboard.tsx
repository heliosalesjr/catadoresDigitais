...
import { useStudentTurmas } from '@/hooks/useTurmas'
import { useUpcomingAulas } from '@/hooks/useTurmas'
import { useStudentFrequencia } from '@/hooks/useTurmas'
    ...
    <main className="p-6 md:p-8">
      <div className="max-w-4xl mx-auto flex flex-col gap-8">
        ...
        {!aulasLoading && activeAula && (() => {
          ...
          return (
            <Link
              to={`/dashboard/aula/${activeAula.turmaId}/${activeAula.id}`}
                ...
                {grouped.map(([date, aulas]) => (
                  <div key={date}>
                    ...
                    {aulas.map((aula) => (
                      <Link
                        key={aula.id}
                        to={`/dashboard/aula/${aula.turmaId}/${aula.id}`}
        ...
        {!authLoading && user && (
          <section>
            <div className="flex items-center justify-between mb-3">
              ...
              {turmaId && (
                <Link
                  to={`/dashboard/turmas/${turmaId}?tab=anotacoes`}
